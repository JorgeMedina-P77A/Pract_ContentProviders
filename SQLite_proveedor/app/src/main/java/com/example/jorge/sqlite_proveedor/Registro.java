    ...
    private void update() {
        ...
        try {
            ...
            if( dao.update(usuario)){
                ...
                Toast.makeText(getBaseContext(), "USUARIO EDITADO", Toast.LENGTH_LONG).show();
                setResult(RESULT_OK, null);
                finish();

            }else {

                Toast.makeText(getBaseContext(), "NO SE EDITO USUARIO", Toast.LENGTH_LONG).show();
    ...
    private void insert() {
        ...
        try {
            ...
            if( dao.insert(usuario)){
                ...
                Toast.makeText(getBaseContext(), "NO SE INSERTO USUARIO", Toast.LENGTH_LONG).show();
                setResult(RESULT_CANCELED, null);
                finish();
